 ...
 * @LastEditTime: 2020-05-10 16:44:57
...
import Utils.Polisher.GrammarPolisher;
...
public class GrammerSpec {
    ...
    @Test
     void connectProductionsSpec() {
        ...
        res.add(new Production("E", "AIB").or('t'));
       ...
       res.containsAll(productions) productions, "connecting fails");
    }
}
