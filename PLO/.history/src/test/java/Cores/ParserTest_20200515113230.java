 ...
 * @LastEditTime: 2020-05-15 11:27:50
...
public class ParserTest {
    ...
    void selectTest() throws Exception {
        ...
        assertEquals(new HashSet<>(Arrays.asList(new Token("b"),new Token("!"),new Token("a"))), follow.get(new Production(
            new NonTerminal("S"),new Vector<Token>(Arrays.asList(new Token("A"),new Token("B")))
        )), "select test fails.");
        assertEquals(new HashSet<>(Arrays.asList(new Token("a"),new Token("!"),new Token("c"))), follow.get(new Production(
