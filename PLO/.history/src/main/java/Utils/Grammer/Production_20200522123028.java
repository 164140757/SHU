...
public class Production {
    ...
    public HashMap<Character,Class<? extends Terminal>> preDefined;
    // index --> aAb...
     ...
     * @return
     */
    public List<Production> translate(String productions)throws Exception {
    ...
    public void addDefinition(char toAdd, Class<? extends Terminal> defineClass) {
        if(preDefined == null){
