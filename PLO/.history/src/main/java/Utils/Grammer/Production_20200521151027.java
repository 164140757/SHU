...
public class Production {
    ...
    public static void addDefinition(String toAdd, List<Production> originalList, Class<? extends Terminal> defineClass)
            throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
            NoSuchMethodException, SecurityException {
        char[] array = toAdd.toCharArray();
        for (int i = 0; i < array.length; i++) {
            Terminal t = defineClass.getDeclaredConstructor(String.class,String.class).newInstance();
