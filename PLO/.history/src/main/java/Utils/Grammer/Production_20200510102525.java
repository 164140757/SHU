 ...
 * @LastEditTime: 2020-05-10 10:25:15
 ...
 * ath: \PLO\src\main\java\Utils\Grammer\Production.java @Description: Productin in Grammer
...
public class Production {
    ...
    List<Production> translate(String ...productions) throws Exception {
        ...
        for (int i = 0; i < productions.length; i++) {
            ...
            Production production = new Production(new NonTerminal(index), Collections.singletonList(toAdd));
            res.add(production);
        }
        return res;
    }
