 ...
 * @LastEditTime: 2020-05-22 14:58:54
...
public class Terminal extends Token {
    public char context;
    public Terminal(final String type,String name,char context) {
        super(type,name);
    ...
    @Override public boolean equals(Object o) {
        ...
        return this.context.equals(nonTerminal.name) && this.type == nonTerminal.type;
    }
    @Override
    public int hashCode() {
