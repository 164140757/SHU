 ...
 * @LastEditTime: 2020-05-22 15:03:11
...
public class Terminal extends Token {
    ...
    @Override public boolean equals(Object o) {
        ...
        Terminal nonTerminal = (NonTerminal) o;
        return this.name.equals(nonTerminal.name) &&this.context.equals(nonTerminal.context)&& this.type == nonTerminal.type;
    }
    @Override
    public int hashCode() {
        return Objects.hash(this.name,this.context,this.type);
    }
