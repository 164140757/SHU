                        ...
                        Token t = production.get(i);
                         ...
                         if (keySet.contains(t.toNonTerminal())) {
                             ...
                             if(i==production.size()-1){
                                ...
                                // record
                                followSetChanged.put(t.toNonTerminal(),set.addAll(stmp));
                                follow.put(t.toNonTerminal(),set);
                             }
                             else{
                                 //terminal
                                 // next
                                 ...
                                 if(isTer(n)){
                                    ...
                                    // record
                                    followSetChanged.put(t.toNonTerminal(),set.add(n));
                                    follow.put(t.toNonTerminal(),set);
                                 }
                                 // nonTerminal first
                                 else{
                                    ...
                                    // if there's empty
                                    if(set.contains(new Token(letter)))
                                    Set<Token> stmp = follow.get(t);
                                    if(stmp==null){
                                        stmp = new HashSet<>();
                                    }
                                    // record
                                    followSetChanged.put(t.toNonTerminal(),stmp.addAll(set));
                                    follow.put(t.toNonTerminal(),stmp);
                                 }
                             }
                         }
                    }
