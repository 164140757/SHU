 ...
 */
    ...
    public void getFollow() {
        boolean changed = followSetChanged.containsValue(true);
        while (changed) {
            // update status
            followSetChanged = new HashMap<>();
                                 ...
                                 if(i==production.size()-1){
                                    updateFollowMap(t,k);
                                     ...
                                     if(isTer(n)){
                                        ...
                                        // record
                                        followSetChanged.put(t,set.addAll(follow.get(index)));follow.put(t,set);
                                     }
                                 }
                             }
                        }
    ...
    private void updateFollowMap(Token t,Token index) {
        Set<Token> set = follow.get(t);
        // record
        followSetChanged.put(t,set.addAll(follow.get(index)));
        follow.put(t,set);
    }
