...
public class Parser {
    ...
    private boolean checkNonTerminal(Production production, Set<Token> tmpFirstSet) {
        ...
        checkProductionFirst(firstSet,tmpFirstSet,production,pEmpty);
        // add to first map
    ...
    private void checkProductionFirst(HashSet<Token> firstSet, Set<Token> tmpFirstSet, Production production,
            boolean pEmpty) {
    ...
    public void getSelect() {
        ...
        productions.forEach((k, v) -> {
            ...
            boolean isEmpty = checkNonTerminal(v, new HashSet<>());
            if(isEmpty){
                HashSet<Token> firstSet;
                Set<Token> tmpFirstSet;
                checkProductionFirst(firstSet, tmpFirstSet, v, pEmpty);
