 ...
 */
    public void getFirst() {
        ...
        productions.forEach((k,v)->{
            checkNonTerminal(v, firstSet);
        });
    }
    /**
 *  Use after making every index decide one production
 *  Recursively check NonTerminal t's targets, and find the NonTerminals and add with hashmap to save and 
 *  
 ...
 */
    private boolean checkNonTerminal(Production production, Set<Token> tmpFirstSet) {
        ...
        // index is not terminal
        // if there is one in first set map, then skip
