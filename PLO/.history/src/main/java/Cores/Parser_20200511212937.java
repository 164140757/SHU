 ...
 * @LastEditTime: 2020-05-11 21:29:37
 ...
 */
    private void checkNonTerminal(Production production,Set<Token> firstSet) {
        ...
        for (Vector<Token> tokens : production.target) {
            ...
            // variable to record if all the tokens ->* #
            int emptyCount = 0;
            ...
            // if all choices consist empty, then there is a empty choice for first set 
            if(emptyCount == tokens.size()){
                firstSet.add()
            }
        }
